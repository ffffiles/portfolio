...
const sH2: React.CSSProperties = { fontSize: 'clamp(28px, 4vw, 48px)', color: '#fefefe', textTransform: 'uppercase', lineHeight: 1.1, margin: 0, textWrap: 'balance' as never }
const sBody: React.CSSProperties = { fontSize: 'clamp(14px, 1.4vw, 24px)', color: '#a2a590', letterSpacing: '-0.96px', lineHeight: 1.4, margin: 0, textWrap: 'pretty' as never }
const sBodySm: React.CSSProperties = { fontSize: 'clamp(14px, 1.2vw, 24px)', color: '#a2a590', letterSpacing: '-0.96px', lineHeight: 1.4, margin: 0, textWrap: 'pretty' as never }
  ...
  return (
    <>
        ...
        {lightboxSrc && (
          ...
          >
            <motion.img
              src={lightboxSrc}
              alt=""
              className="lightbox-img max-w-[90vw] max-h-[90vh] object-contain rounded-lg shadow-2xl"
              draggable={false}
      ...
      <button
        ...
        style={{ position: 'fixed', top: 12, left: 24, zIndex: 40, mixBlendMode: 'exclusion', background: 'none', border: 'none', padding: '12px 0', cursor: 'pointer', width: 70, lineHeight: 0, transition: 'opacity 0.15s ease' }}
      >
      ...
      <div ref={scrollRef} style={{ height: '100vh', overflowY: 'auto' }}>
        ...
        <section style={isMobile
          ...
          >
            ...
            <svg data-entrance="1" width="28" height="30" viewBox="0 0 28.0603 30.0036" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ opacity: 0.5, flexShrink: 0 }}>
            ...
            {/* Label */}
            <p data-entrance="2" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600, fontSize: 12, color: '#a2a590', letterSpacing: '1.2px', textTransform: 'uppercase', margin: 0, textAlign: 'center' }}>
              Visual Design @ Riot Games
            </p>
            {/* H1 */}
            <h1 data-entrance="3" className="font-tungsten" style={{ fontSize: 'clamp(56px, 7vw, 110px)', color: '#dfe1d3', textTransform: 'uppercase', letterSpacing: '-1.1px', lineHeight: 1, margin: 0, textAlign: 'center', textWrap: 'balance' as never }}>
              Valorant Esports
            </h1>
            {/* Subtitle */}
            <p data-entrance="4" className="font-noto" style={{ fontSize: 'clamp(16px, 1.5vw, 24px)', color: '#a2a590', letterSpacing: '-0.96px', lineHeight: 1.4, margin: 0, textAlign: 'center', maxWidth: 800, textWrap: 'pretty' as never }}>
